	...
	<div id="panel" class="easyui-panel" title="修改文章信息"
		...
		<form id="editForm"
			...
			<table class="table-form">
				...
				<tr>
					...
					<td><select id="type" class="easyui-combobox" name="type"
						url="<%=request.getContextPath()%>/app/system/dict/listDictByType.action?type=article.state"
				...
				<tr>
					...
					<td><input id="createTime" name="createTime" type="text"
						value="${article.createTime}" readonly="readonly"></input></td>
					<td><div id="titleTip"></div></td>
				</tr>
				<tr>
					<td style="text-align: right"><span style="color: red">*</span>创建人:</td>
					<td><input id="operaterName" name="operaterName" type="text"
						value="${article.operaterName}" readonly="readonly"></input></td>
					<td><div id="titleTip"></div></td>
				</tr>
				<tr>
					<td colspan="3">
			...
			<input id="id" type="hidden" name="id" type="text"
				value="${article.id}"></input> <input id="typeName" type="hidden"
				name="typeName" type="text" value="${article.typeName}"></input> <input
				id="stateName" type="hidden" name="stateName" type="text"
				value="${article.stateName}"></input> <input id="operater"
				type="hidden" name="operater" type="text"
				value="${article.operater}"></input>
		</form>
	</div>
</body>
<script type="text/javascript">
