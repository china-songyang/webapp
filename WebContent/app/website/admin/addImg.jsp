...
<body>
	<div id="panel" class="easyui-panel" title="添加图片信息"
		icon="icon-add-form" collapsible="true" style="padding: 10px;">
		<form id="addForm"
			action="<%=request.getContextPath()%>/app/website/admin/addImg.action"
			method="post">
			<table>
				<tr>
					<td width="550px">
			...
			<input id="articleId" type="hidden" name="articleId" type="text" value="<%=articleId%>"></input>
