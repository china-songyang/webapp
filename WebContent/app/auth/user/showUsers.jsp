...
<body>
	<div id="panel" class="easyui-panel" title="查询条件"
		...
		<form id="queryForm" method="post">
			<label for="id">登录ID:</label> <input id="id" type="text" name="id"></input>
			<label for="name">姓名:</label> <input id="name" type="text"
				name="name"></input> <label for="email">邮箱:</label> <input
				id="email" type="text" name="email"></input> <label for="phone">电话
				:</label> <input id="phone" type="text" name="phone"></input>
