...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#type').combobox("select", "${dict.type}");
...
<body>
	<div id="panel" class="easyui-panel" title="修改角色信息" icon="icon-save"
		collapsible="true" style="padding: 10px;">
		<form id="editForm"
			action="<%=request.getContextPath()%>/app/system/dict/updateDict.action"
			method="post">
