...
insert  into `auth_organizations`(`id`,`name`,`description`,`responsible`,`parentId`) values (4,'董事长','','否','3'),(5,'总经理','','是','3'),(6,'销售副总','','否','3'),(7,'售后副总','','否','3'),(8,'财务副总','','否','3'),(9,'人事副总','','否','3'),(10,'人事部','','否','3'),(11,'人事部长','','是','10'),(12,'人事部副部长','','否','10'),(13,'人事部助理','','否','10'),(14,'人事部成员','','否','10'),(15,'销售部','','否','3'),(16,'销售部长','','是','15'),(17,'长春市绿园区政府','','否',NULL),(18,'新闻科','','否','17');
...
insert  into `auth_re_organization_user`(`organizationId`,`userId`) values (5,'admin'),(11,'zhangsan'),(12,'admin'),(16,'lisi'),(18,'admin');
...
insert  into `auth_users`(`Id`,`name`,`password`,`email`,`phone`) values ('admin','管理员','lueSGJZetyySpUndWjMBEg==','',''),('system','开发维护员','lueSGJZetyySpUndWjMBEg==','',''),('yangrunjia','杨润佳','K1mO6sM3dzjh0BhKw7TvaA==','','');
...
insert  into `mobile_message`(`id`,`title`,`text`,`state`,`statename`,`createtime`,`creater`,`creatername`,`level`,`type`,`userid`) values (1,'标题','内容','状态','状态名称','2013-06-16','宋阳','宋阳','普通','消息','1'),(2,'哈哈','哈哈','true','正常','2013-06-15','张飞','张飞','重要','消息','1');
